...
class AIServiceAnthropic {
  constructor() {
    this.anthropicApiKey = process.env.ANTHROPIC_API_KEY;
    this.anthropicBaseUrl = 'https://api.anthropic.com/v1';
    
    if (!this.anthropicApiKey) {
      console.warn('Anthropic API key not found. Please set ANTHROPIC_API_KEY environment variable.');
    }
  }
  ...
  // Search for additional health information
...
module.exports = new AIServiceAnthropic();
